...
VALUES (${escapeSql(user.name)}, ${escapeSql(user.username)}, ${escapeSql(user.email)}, ${escapeSql(hashedPassword)}, ${escapeSql(user.phone)}, ${escapeSql(user.type)}, ${escapeSql(user.address)}, ${escapeSql(user.bio)})
...
SELECT id, ${escapeSql(user.name)}, ${escapeSql(user.email)}, ${escapeSql(user.category)}, ${escapeSql(user.address)}, ${escapeSql(user.phone)}, ${escapeSql(user.bio)}, ${escapeSql(user.address)}
FROM users WHERE email = ${escapeSql(user.email)}
