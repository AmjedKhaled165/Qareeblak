                ...
                <DialogContent className="sm:max-w-[600px] rounded-[2rem] bg-card border-border/50 shadow-2xl p-0 overflow-hidden font-cairo">
                    ...
                    <div className="p-6 space-y-8 max-h-[60vh] overflow-y-auto">
                        ...
                        <Button 
                            ...
                            className="w-full h-14 rounded-xl border-dashed border-2 border-emerald-500/30 text-emerald-600 bg-emerald-500/5 hover:bg-emerald-500/10 hover:border-emerald-500 font-bold gap-2 shadow-sm mt-4"
                        >
                            <PackagePlus className="w-5 h-5" />
