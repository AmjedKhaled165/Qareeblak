...
export default function WheelOfFortunePage() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 pb-20">
            ...
            {/* Header */}
            <header className="bg-white dark:bg-slate-900 px-6 py-4 sticky top-0 z-20 flex items-center justify-between border-b border-slate-100 dark:border-slate-800 shadow-sm transition-colors">
                <div className="flex items-center gap-3">
                    <Link href="/explore">
                        <Button variant="ghost" size="icon" className="rounded-full w-10 h-10 -mr-2 bg-slate-50 dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <h1 className="text-xl font-bold dark:text-white">عجلة الحظ</h1>
                    </div>
                </div>
            </header>
            ...
            <main className="max-w-md mx-auto p-4 space-y-6">
                ...
                {/* The Wheel */}
                <div className="bg-white dark:bg-slate-900 p-6 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-800 flex flex-col items-center py-10 transition-colors">
                ...
                <div className="space-y-4">
                    ...
                    {myPrizes.length === 0 ? (
                        <div className="bg-white dark:bg-slate-900 p-6 rounded-3xl text-center border border-slate-100 dark:border-slate-800 shadow-sm transition-colors">
                            <div className="w-16 h-16 mx-auto bg-slate-50 dark:bg-slate-800 rounded-full flex justify-center items-center text-slate-300 dark:text-slate-500 mb-3">
                                <AlertCircle className="w-8 h-8" />
                            </div>
                            <p className="text-slate-500 dark:text-slate-400 font-medium">لم تكسب أية جوائز بعد، اضغط على جرب حظك الان!</p>
                        </div>
                    ) : (
                        <div className="grid gap-3">
                            {myPrizes.map((prize, idx) => (
                                <motion.div
                                    ...
                                    key={idx}
                                    className="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm flex items-center gap-4 group transition-colors"
                                >
                                    <div
