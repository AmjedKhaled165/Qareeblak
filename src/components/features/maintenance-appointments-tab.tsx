...
export function MaintenanceAppointmentsTab({ providerId, services, onServicesUpdated }: any) {
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex flex-col md:flex-row gap-4 items-end bg-card p-4 rounded-2xl border border-border/50 shadow-sm">
                ...
                <Button 
                    ...
                    className="h-11 bg-blue-600 hover:bg-blue-700 text-white w-full md:w-auto"
                >
                        ...
                        {sortedSlots.map((slot, idx) => (
                            <div key={idx} className="p-4 flex justify-between items-center hover:bg-muted/10 transition-colors">
                                <div className="flex items-center gap-4">
                                    <div className="bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 px-3 py-1.5 rounded-lg font-bold flex items-center gap-2">
